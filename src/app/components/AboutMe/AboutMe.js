      ...
      >
        <div className="container m-auto">
          ...
          <h4 className="relative w-full font-[300] md:w-3/4 lg:w-2/3 xl:w-1/2 font-recoleta text-[#223740] text-2xl mb-10 px-5 md:px-24">
            Crafting Scalable and Intuitive Full-Stack Solutions with Precision
            and Innovation
          </h4>
          <section className="relative flex flex-col lg:flex-row px-5 md:px-24">
            ...
            >
              {" "}
              My name is Sayuru Samarawickrama—a passionate and driven
              full-stack developer and coding instructor with a deep love for
              problem-solving and innovation. I’m not just your average
              programmer or designer; I thrive on learning and evolving,
              constantly refining my craft and exploring cutting-edge
              technologies. 🚀
            </p>
            <p
              className={`w-full lg:w-1/3 text-[#223740] mr-0 mb-5  lg:mr-4 font-[200] ${hind.className}`}
            >
              {" "}
              With hands-on experience in front-end and back-end development,
              UI/UX design, software architecture, and data analysis, I bring a
              dynamic approach to building intuitive, scalable applications.
              I’ve worked on diverse projects, from full-stack e-commerce
              applications to AI-driven data analytics tools, always focusing on
            ...
            >
              {" "}
              Beyond coding, I enjoy mentoring and teaching, sharing my
              knowledge of programming languages like Python, Java, C++,
              JavaScript, and cutting-edge frameworks such as React, Node.js,
              and Firebase. My goal is to build impactful and seamless digital
              experiences. 🚀
            </p>
          </section>
        </div>
